...
module.exports = function (
  ...
  const oAuthMint = require('./utils/oauth-mint')(config, signer)
  const devicesSessions = require('./devices-and-sessions')(log, db, config, customs, push, pushbox, devicesImpl, oAuthMint)
